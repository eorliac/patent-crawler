...
public class PatentSiteMapDetectorBolt extends SiteMapParserBolt {

    private static final org.slf4j.Logger LOG = LoggerFactory
            .getLogger(PatentSiteMapDetectorBolt.class);
    ...
    public void execute(Tuple tuple) {
        ...
        boolean isNewsSitemap = Boolean.valueOf(
                metadata.getFirstValue(PatentSiteMapParserBolt.isSitemapNewsKey));
            ...
            if (match >= 0) {
                ...
                if (match == 0) {
                    ...
                    LOG.info("{} detected as news sitemap based on content",
                            url);
                    metadata.setValue(PatentSiteMapParserBolt.isSitemapNewsKey,
                            "true");
                }
            }
        }
